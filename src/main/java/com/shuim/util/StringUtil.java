...
*/	
    ...
    public static boolean StringCheck(String str){
    	...
    	boolean result_check1 =  str.contains("viagra");
    	boolean result_check2 =  str.contains("cialis");
    	boolean result_check3 =  str.contains("http");
    	
    	
    	if((result_check1==true) || (result_check2==true) || (result_check3==true)){
    		result = true;
    	}
